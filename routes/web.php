...
Route::controller(PosController::class)->group(function(){
 ...
 Route::post('/cart/update-price/{rowId}', [PosController::class, 'UpdateCartPrice']);
...
Route::get('/invoice/payment/{cartTotal}/{customer_id}', [OrderController::class, 'ShowInvoicePayment'])->name('invoice.payment');
...
Route::get('/backup/now', [AdminController::class, 'BackupNow'])->name('backup.now');
Route::get('/backup/download/{filename}', [AdminController::class, 'DownloadDatabase'])->name('backup.download');
Route::get('/backup/delete/{filename}', [AdminController::class, 'DeleteDatabase'])->name('backup.delete');
});
