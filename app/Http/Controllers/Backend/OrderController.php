...
class OrderController extends Controller
{
  ...
  $totalQuantityRestored = Orderdetails::whereIn('id', $rejectedItemIds)
            ...
            // ✅ FIX: Delta approach — reverse only what this order contributed.
            // FinalInvoice did: customer.due += (sub_total - pay)
            // So cancellation does: customer.due -= (sub_total - pay)
            // This preserves any pre-existing opening balance or unrelated payments.
