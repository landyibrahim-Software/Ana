...
<html lang="en">
    ...
    <body class="authentication-bg authentication-bg-pattern">
                    ...
                    <div class="col-lg-4">
                        <div class="card">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center">
                                    ...
                                    <p class="text-muted mb-0">بەکارهێنەر ڕیگەپێدانی تەواوی نیە بۆ ئەم بەشە</p>
                                </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                <p class="text-white-50">بگەڕێرەوە بۆ to <a href="{{ route('dashboard') }}" class="text-white ms-1"><b>پەیجی سەرەکی</b></a></p>
                            </div> <!-- end col -->
                        </div>
                        <!-- end row -->
        ...
        <footer class="footer footer-alt">
            2026 - <script>document.write(new Date().getFullYear())</script> &copy; Landy Ibrahim <a href="" class="text-white-50"> </a> 
        </footer>
