                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">دەستکاریکردنی خەرجی </a></li>
                                            
                                        </ol>
                                    </div>
                                    <h4 class="page-title">دەستکاریکردنی خەرجی </h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title -->
...
<div class="card">
    ...
    <div class="tab-pane" id="settings">
        <form method="post" action="{{ route('expense.update') }}" enctype="multipart/form-data">
            ...
            <h5 class="mb-4 text-uppercase"><i class="mdi mdi-account-circle me-1"></i>زیادکردنی خەرجی </h5>
    ...
    <div class="col-md-12">
        <div class="mb-3">
            <label for="firstname" class="form-label">وردەکاری خەرجی</label>
    ...
    <div class="col-md-12">
        <div class="mb-3">
            <label for="firstname" class="form-label">بڕ </label>
