                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">زیادکردنی خەرجی </a></li>
                                            
                                        </ol>
                                    </div>
                                    <h4 class="page-title">زیادکردنی خەرجی </h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title -->
...
<div class="card">
    ...
    <div class="col-md-12">
        <div class="mb-3">
            <label for="firstname" class="form-label">زانیاری خەرجی</label>
