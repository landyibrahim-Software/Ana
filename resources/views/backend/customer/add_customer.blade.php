                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">زیادکردنی کڕیار</a></li>
                                            
                                        </ol>
                                    </div>
                                    <h4 class="page-title">زیادکردنی کڕیار</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title -->
...
<div class="card">
    ...
    <div class="tab-pane" id="settings">
        <form method="post" action="{{ route('customer.store') }}" enctype="multipart/form-data">
            ...
            <h5 class="mb-4 text-uppercase"><i class="mdi mdi-account-circle me-1"></i> زیادکردنی کڕیار</h5>
    ...
    <div class="col-md-6">
      ...
      <span class="text-danger"> {{ $message }} </span>
            @enderror
              ...
              <div class="col-md-6">
        <div class="mb-3">
            <label for="firstname" class="form-label">ژمارەی مۆبایلی کڕیار    </label>
 ...
 <div class="col-md-6">
        <div class="mb-3">
            <label for="firstname" class="form-label">خاوەن ئەکاونت    </label>
     ...
     <div class="col-md-6">
        <div class="mb-3">
            <label for="firstname" class="form-label">ژمارەی ئەکاونت    </label>
