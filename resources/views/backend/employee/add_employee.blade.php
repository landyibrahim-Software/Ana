                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">زیادکردنی کارمەند</a></li>
                                            
                                        </ol>
                                    </div>
                                    <h4 class="page-title">زیادکردنی کارمەند</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title -->
...
<div class="card">
    ...
    <div class="tab-pane" id="settings">
        <form method="post" action="{{ route('employee.store') }}" enctype="multipart/form-data">
            ...
            <h5 class="mb-4 text-uppercase"><i class="mdi mdi-account-circle me-1"></i> زیادکردنی کارمەند</h5>
      ...
      <div class="col-md-6">
        <div class="mb-3">
           ...
           <select name="experience" class="form-select @error('experience') is-invalid @enderror" id="example-select">
                    ...
                    <option value="1 Year"> ١ ساڵ</option>
                    <option value="2 Year">٢ ساڵ</option>
                    <option value="3 Year">٣ ساڵ</option>
                    <option value="4 Year">٤ ساڵ</option>
                    <option value="5 Year">٥ ساڵ</option>
                </select>
                 @error('experience')
      <span class="text-danger"> {{ $message }} </span>
            @enderror
