...
<div class="content">
               ...
               <div class="page-title-right">
                  <ol class="breadcrumb m-0">
                     <h4>
                         ...
                         <h4>دەستکاریکردنی ئامادەبوونی کارمەند</h4>
                        <a href="{{ route('employee.attend.list') }}" class="btn btn-primary float-sm-right"> <i class="fas fa-list"></i>لیستی ئامادەبوونی کارمەندان</a>
                     </h4>
                  </ol>
               </div>
            </div>
               ...
               <div class="card-body">
                  <form action="{{ route('employee.attend.store') }}" method="post" id="myForm">
                     ...
                     <div class="form-group col-md-4">
                        <label for="date" class="control-label">بەرواری ئامادەبوون</label>
 ...
 <button type="submit" class="btn btn-success btn-sm"> تازەکردنەوە  </button>
</form>
</div>
               <!-- end card body-->
