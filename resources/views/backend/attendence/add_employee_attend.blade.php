...
<div class="content">
               ...
               <div class="page-title-right">
                  <ol class="breadcrumb m-0">
                     <h4>
                        ...
                        <a href="{{ route('employee.attend.list') }}" class="btn btn-primary float-sm-right"> <i class="fas fa-list"></i>لیستی ئامادەبونی کارمەندان</a>
                     </h4>
                  </ol>
               </div>
            </div>
               ...
               <div class="card-body">
                  <form action="{{ route('employee.attend.store') }}" method="post" id="myForm">
                     ...
                     <div class="form-group col-md-4">
                        <label for="date" class="control-label">بەرواری ئامادەبون</label>
                     ...
                     <table class="table sm table-bordered table-striped dt-responsive" style="width: 100%">
                        <thead>
                           <tr>
                              ...
                              <th rowspan="2" class="text-center" style="vertical-align: middle">ناوی کارمەند</th>
                              <th colspan="3" class="text-center" style="vertical-align: middle">دۆخی ئامادەبون</th>
                           </tr>
                           <tr>
                              <th class="text-center btn present_all" style="display: table-cell;background-color:#114190">ئامادەبوو</th>
                              <th class="text-center btn leave_all" style="display: table-cell;background-color:#114190">جێهێشتن</th>
                              <th class="text-center btn absent_all" style="display: table-cell;background-color:#114190">نەهاتوو</th>
                           </tr>
                        </thead>
    <tbody>
 ...
 <button type="submit" class="btn btn-success btn-sm"> پێشکەشکردن </button>
</form>
</div>
               <!-- end card body-->
...
<script type="text/javascript">
      ...
      $(this).parents('tr').find('.datetime').css('pointer-events','none').css('background-color','#dee2e6').css('color','#dee6e1');
      });
</script>
<script type="text/javascript">
