                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">زیادکردنی دابینکەر</a></li>
                                            
                                        </ol>
                                    </div>
                                    <h4 class="page-title">زیادکردنی دابینکەر</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title -->
...
<div class="card">
    ...
    <div class="tab-pane" id="settings">
        <form method="post" action="{{ route('supplier.store') }}" enctype="multipart/form-data">
            ...
            <h5 class="mb-4 text-uppercase"><i class="mdi mdi-account-circle me-1"></i> زیادکردنی دابینکەر</h5>
    ...
    <div class="col-md-6">
      ...
      <div class="col-md-6">
        <div class="mb-3">
            <label for="firstname" class="form-label">ناونیشان    </label>
  ...
  <div class="col-md-6">
        <div class="mb-3">
           ...
           <select name="type" class="form-select @error('type') is-invalid @enderror" id="example-select">
                    <option selected disabled >جۆری دابینکەر هەڵبژێرە </option>
                    <option value="Distributor">دابینکەری گشتی </option>
                    <option value="Whole Seller">دابینکەری کۆمپانیایی </option> 
                </select>
                 @error('type')
      <span class="text-danger"> {{ $message }} </span>
            @enderror
