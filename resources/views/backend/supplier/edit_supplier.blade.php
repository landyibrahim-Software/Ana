                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">دەستکاریکردن دابینکەر</a></li>
                                            
                                        </ol>
                                    </div>
                                    <h4 class="page-title">دەستکاریکردن دابینکەر</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title -->
...
<div class="card">
    ...
    <div class="tab-pane" id="settings">
        <form method="post" action="{{ route('supplier.update') }}" enctype="multipart/form-data">
           ...
           <input type="hidden" name="id" value="{{ $supplier->id }}"> 
            ...
            <h5 class="mb-4 text-uppercase"><i class="mdi mdi-account-circle me-1"></i> دەستکاریکردن دابینکەر</h5>
  ...
  <div class="col-md-6">
        <div class="mb-3">
           ...
           <select name="type" class="form-select @error('type') is-invalid @enderror" id="example-select">
                    <option selected disabled >جۆر دیاریبکە </option>
                    <option value="Distributor" {{ $supplier->type == 'Distributor' ? 'selected' : '' }}>دابەشکار </option>
                    <option value="Whole Seller" {{ $supplier->type == 'Whole Seller' ? 'selected' : '' }}>کۆمپانیا </option> 
                </select>
                 @error('type')
      <span class="text-danger"> {{ $message }} </span>
            @enderror
 ...
 <div class="col-md-6">
   ...
   <div class="col-md-12">
<div class="mb-3">
        <label for="example-fileinput" class="form-label">وێنەی دابینکەر</label>
