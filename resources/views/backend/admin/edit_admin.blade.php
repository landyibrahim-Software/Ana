                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);"> دەستکاریکردنی ئادمین</a></li>
                                            
                                        </ol>
                                    </div>
                                    <h4 class="page-title">دەستکاریکردنی ئادمین</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title -->
...
<div class="card">
    ...
    <div class="tab-pane" id="settings">
        <form id="myForm" method="post" action="{{ route('admin.update') }}" enctype="multipart/form-data">
            ...
            <h5 class="mb-4 text-uppercase"><i class="mdi mdi-account-circle me-1"></i> دەستکاریکردنی ئادمین</h5>
      ...
      <div class="col-md-6">
        <div class="form-group mb-3">
            ...
            <select name="roles" class="form-select" id="example-select">
                    <option selected disabled >ڕۆڵ هەڵبژێرە </option>
