    ...
    <body class="authentication-bg authentication-bg-pattern">
                    ...
                    <span class="logo-lg">
                        <img src="{{ asset('backend/assets/images/nza.png') }}" alt="" height="100">
                                ...
                                <div class="text-center">
                                    ...
                                    <h3>بە هیوای بەکارهێنانەوە !</h3>

                                    <p class="text-muted">بە سەرکەوتوی چویتە دەرەوە  </p>
                                </div>
        ...
        <div class="row mt-3">
            <div class="col-12 text-center">
                <p class="text-white-50">بگەڕیرەوە بۆ <a href="{{ route('login') }}" class="text-white ms-1"><b>چونەژورەوە</b></a></p>
            </div> <!-- end col -->
        </div>
                        <!-- end row -->
